                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                ...
                                <div class="street">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"><p>I have a ready and agree to the website <span class="here">terms and conditions</p></span></label>
                                      </div> 
                                </div>
...
if (str_contains($url, 'out-of-service')) { 
