...
<div class="main-menu">
    ...
    <div class="logo-box">
        ...
        <a href="index.html" class="logo-light">
            <img src="public/dashboard1/images/logo-light.png" alt="logo" class="logo-lg" height="28">
            <img src="public/dashboard1/images/logo-sm.png" alt="small logo" class="logo-sm" height="28">
        </a>

        <!-- Brand Logo Dark -->
        <a href="index.html" class="logo-dark">
            <img src="public/dashboard1/images/logo-dark.png" alt="dark logo" class="logo-lg" height="28">
            <img src="public/dashboard1/images/logo-sm.png" alt="small logo" class="logo-sm" height="28">
        </a>
    </div>
        ...
        <ul class="app-menu">
            ...
            <li class="menu-item">
                <a href="index.html" class="menu-link waves-effect waves-light">
                    ...
                    <span class="menu-text"> dashboard1s </span>
